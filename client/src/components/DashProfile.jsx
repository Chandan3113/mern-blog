...
import { updateFailure,updateStart,updateSucess,deletUserStart,deleteUserFailure,deleteUserSuccess,signoutSuccess } from '../redux/user/userSlice'
...
const DashProfile = () => {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            // this is created for my borwser aur kisi ke browser ni hoga yeh
        }
    };
        useEffect(() => {
            if (imageFile) {
        ...
        const uploadImage = async () => {
            ...
            uploadTask.on(
                ...
                (error) => {
                    setImageFileUploadError('Coud not image upload Image (File must be less then 2MB)');
    ...
    return (
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                ...
                <div className='w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full relative' onClick={() => filePickRef.current.click()}>
